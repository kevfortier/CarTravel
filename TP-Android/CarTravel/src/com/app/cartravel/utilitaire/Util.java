...
public class Util {
	...
	public final static String REST_PARCOURS_PASSAGER = "/parcoursPassagers";
	public final static String REST_CONNEXION = "/connexion";
	public final static String WEB_SERVICE = "192.168.43.191:8080";
	...
	// Permet de vÈrifier les saisies de type Integer.
	...
	// Permet de vÈrifier les saisies de type Float.
	...
	// Permet de vÈrifier les saisies de chaÓnes de caractËres incluant les
	// caractËres avec accents.
	public static boolean verifChaineCharac(String p_Chaine) {
		boolean verifChaine = false;
		String regEx = "[a-zA-ZÈË‡ÍÙÎÔ]+";
