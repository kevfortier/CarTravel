...
public class JsonParcours {
	...
	public static ArrayList<Parcours> parseListeParcours(String p_body) throws JSONException {
		...
		for (int i =0; i < array.length(); i++){
			...
			Parcours parcours = new Parcours( jsonParcours.getInt(PARCOURS_ID), jsonParcours.getInt(PARCOURS_PROPRIETAIRE), jsonParcours.getInt(PARCOURS_CONDUCTEUR),
					jsonParcours.getString(PARCOURS_JOUR), jsonParcours.getString(PARCOURS_HEURE), jsonParcours.getBoolean(PARCOURS_REPETITIF),
					jsonParcours.getInt(PARCOURS_NBR_PLACES_DISPO), jsonParcours.getInt(PARCOURS_NBR_PLACES_PRISE),
					(float) jsonParcours.getDouble(PARCOURS_DIST_SUPP_MAX), jsonParcours.getString(PARCOURS_NUM_CIV_DEP),
					jsonParcours.getString(PARCOURS_RUE_DEP), jsonParcours.getString(PARCOURS_VILLE_DEP),
					jsonParcours.getString(PARCOURS_CODE_POSTAL_DEP), jsonParcours.getString(PARCOURS_NUM_CIV_ARR),
					jsonParcours.getString(PARCOURS_RUE_ARR), jsonParcours.getString(PARCOURS_VILLE_ARR),
	...
	public static JSONObject ToJSONObject(Parcours parcours) throws JSONException {
