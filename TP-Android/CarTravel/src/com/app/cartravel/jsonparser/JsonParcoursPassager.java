...
public class JsonParcoursPassager {
	...
	public static ArrayList<ParcoursPassager> parseListeParcours(String p_body)
		...
		for (int i = 0; i < array.length(); i++) {
			...
			jsonParcoursPassager.getString(PARCOURS_PASSAGER_ID_PASSAGERS),
	...
	public static JSONObject ToJSONObject(ParcoursPassager parcoursPassager)
		...
		jsonObj.put(PARCOURS_PASSAGER_ID, parcoursPassager.getIdParcoursPassager());
		jsonObj.put(PARCOURS_PASSAGER_ID_PASSAGERS, (ArrayList<String>)parcoursPassager.getListIdPassager());
		jsonObj.put(PARCOURS_PASSAGER_NBR_PASSAGERS, parcoursPassager.getNbrPassagers());
