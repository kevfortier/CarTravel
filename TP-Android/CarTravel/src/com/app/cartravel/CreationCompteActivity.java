...
public class CreationCompteActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		courrielConfirmation = (EditText) this
				.findViewById(R.id.new_username_confirmation);
		pseudo = (EditText) this.findViewById(R.id.new_pseudo);
		motDePasse = (EditText) this.findViewById(R.id.new_password);
		motDePasseConfirmation = (EditText) this
				.findViewById(R.id.new_password_confirmation);
	}

	public void CreerCompte(View source) {

		String strCourriel = courriel.getText().toString().trim();
		String strCourrielConfirmation = courrielConfirmation.getText()
				.toString().trim();
		...
		if (Util.ValiderString(new String[] { strCourriel,
			...
			if (!Util.ValiderString(new String[] { strPseudo })) {
				Toast.makeText(
						this,
						this.getResources().getText(R.string.toast_pseudo_vide),
						Toast.LENGTH_SHORT).show();
			}
			...
			if (m_Exp == null) {
				...
				Toast.makeText(
						...
						m_Context.getResources().getText(
								R.string.toast_compte_creer), Toast.LENGTH_LONG)
						.show();
				...
				Toast.makeText(
						m_Context,
						m_Context.getResources().getText(
								R.string.toast_erreur_creation_compte),
						Toast.LENGTH_SHORT).show();
